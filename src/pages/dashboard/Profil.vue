<template>
  <div class="container pb-5 my-2 col-12">
        ...
        <form @submit.prevent="handleUpdateProfile">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <textarea v-model="form.address" class="form-control" rows="2" :disabled="!isEditing"></textarea>
            </div>
          </div>
        </form>
      </div>
...
const handleChangePassword = async () => {
    ...
    else if (updateErrorPw.value) Toast(t("errorUpdatePassword"), 'error')
    else {
        Toast(t("successUpdatePassword"), 'success')
