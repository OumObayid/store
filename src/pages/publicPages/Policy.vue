<template>
    <div class="container privacy-section text-start">
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    this Agreement) refers to Mimaya.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to Mimaya, accessible from
                    <a :href="siteUrl" rel="external nofollow noopener" target="_blank">
                        {{ siteUrl }}
                    </a>
                </p>
            </li>
        ...
        <ul>
            <li>        <p>The Company may use Personal Data for the following purposes:</p>
        ...
        <ul>
            <li>        <p>We may share Your personal information in the following situations:</p>
...
/* Pour éviter que le contenu soit caché sous une navbar fixed-top */
.privacy-section {
    padding-top: 2rem;
    color: #333;
}
