  ...
  <div class="container-fluid-md pt-3">
    ...
    <div class="card shadow-sm border-0 rounded-4">
      <div class="d-flex justify-content-end align-items-center pt-3 me-3">
        ...
        <router-link
          to="/admin/categories"
          class="btn my-btn-outline-gold mx-2"
        >
      ...
      <div class="card-body">
        <form @submit.prevent="handleUpdate" class="row g-4">
          <!-- Nom Français -->
          <div class="col-md-6">
            <label class="form-label fw-semibold text-gold"
              >Nom (Français)</label
            >
            <input
              type="text"
          ...
          <div class="col-md-6">
            ...
            <input
              type="text"
              v-model="category.nom_ar"
              class="form-control border-gold rounded-4 text-end"
              dir="rtl"
...
async function handleUpdate() {
  try {
    ...
    if (!error_editCategorie.value) {
      Toast(t("categoryUpdatedSuccessfully"), "success");
    } else {
      Toast(t("categoryUpdatedError"), "error");
    }
  } catch (error) {
