<template>
  <footer class="footer bg-dark text-white py-5">
    <div class="container">
      ...
      <!-- Politique & Copyright -->
      <div class="row">
        <div class="col-12 text-center d-flex flex-column flex-sm-row justify-content-center">
          <router-link to="/policy" class="footer-link me-0 me-sm-3 mb-2 mb-sm-0 mx-2">
            {{ $t("privacyPolicy") }}
          </router-link>
